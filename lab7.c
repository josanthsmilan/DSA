...
int main() {
    ...
    printf("Enter the number of Turfs for level order traversal: ");
    scanf("%d", &n);

    int levelOrderArr[n];
    printf("Enter the Turf in level order: ");
    for (i = 0; i < n; i++) {
    ...
    printf("Enter the number of Turfs for pre-order and in-order traversals: ");
    scanf("%d", &n);

    int preOrderArr[n], inOrderArr[n];
    printf("Enter the Turf ID's for pre-order traversal: ");
    for (i = 0; i < n; i++) {
        scanf("%d", &preOrderArr[i]);
    }

    printf("Enter the Turf ID's for in-order traversal: ");
    for (i = 0; i < n; i++) {
    ...
    printf("Turf ID's Of In-order Traversal: ");
    inorder(preInOrderRoot);
    printf("\n");

    printf("Turf ID's Of Pre-order Traversal: ");
    preorder(preInOrderRoot);
    printf("\n");

    printf("Turf ID's Of Post-order Traversal: ");
